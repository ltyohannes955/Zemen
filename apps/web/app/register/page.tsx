...
import { Calendar01Icon, Mail01Icon, LockPasswordIcon, UserIcon, ViewIcon, ViewOffIcon } from 'hugeicons-react';
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        ...
        <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">Join Zemen to manage your time.</p>
          </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <Link href="/login" className="text-[#0B3D16] hover:text-[#082a0f] dark:text-emerald-500 font-semibold">
            Sign in
          </Link>
        </div>
      </div>
