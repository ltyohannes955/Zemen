...
const task: ViewTask = { id: '1', title: 'Design review', dateType: 'gregorian', primaryYear: 2024, primaryMonth: 6, primaryDay: 10, time: null, priority: 'medium', status: 'pending', tags: ['design', 'frontend'] };
